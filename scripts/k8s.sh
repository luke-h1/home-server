...
ENV_SUBST_FORMAT='${IMMICH_DOMAIN}${IMMICH_PUBLIC_URL}${GRAFANA_DOMAIN}${PROMETHEUS_DOMAIN}${ALERTS_DOMAIN}${GRAFANA_ROOT_URL}${ALERTS_BASIC_AUTH_USER}${ALERTS_BASIC_AUTH_PASSWORD}${BACKUP_S3_BUCKET}${BACKUP_S3_PREFIX}${AWS_REGION}'
